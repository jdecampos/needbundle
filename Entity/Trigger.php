...
class Trigger extends FormEntity
{
    ...
    /**
     * @var \MauticPlugin\KompulseNeedBundle\Entity\Need
     **/
    private $need;
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('plugin_kompulse_need_point_triggers')
            ->setCustomRepositoryClass('MauticPlugin\KompulseNeedBundle\Entity\TriggerRepository');
        ...
        $builder->createManyToOne('need', 'MauticPlugin\KompulseNeedBundle\Entity\Need')
            ->addJoinColumn('need_id', 'id', true, false, 'SET NULL')
            ->build();
