...
echo $view['form']->row($form['points']);
                    ...
                    <div class="tab-pane fade bdr-w-0" id="events-container">
                        <div id="triggerEvents">
                            <div class="mb-md">
                                <p><?php echo $view['translator']->trans('kompulse.point.trigger.addevent'); ?></p>
                                <div class="dropdown">
                                    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                                        <?php echo $view['translator']->trans('kompulse.trigger.event.add'); ?>
                                        ...
                                        <?php foreach ($events as $group => $event): ?>
                                            ...
                                            <?php foreach ($event as $k => $e): ?>
                                                <li id="event_<?php echo $k; ?>">
                                                    <a data-toggle="ajaxmodal" data-target="#triggerEventModal" class="list-group-item" href="<?php echo $view['router']->path('kompulse_pointtriggerevent_action', ['objectAction' => 'new', 'type' => $k, 'tmpl' => 'event', 'triggerId' => $sessionId]); ?>">
                            ...
                            foreach ($triggerEvents as $event):
                                ...
                                'KompulseNeedBundle:Event:generic.html.php';
