...
$view['slots']->set('mauticContent', 'need_point');
...
Mautic.getNeedPointActionPropertiesForm = function(actionType) {
    Mautic.activateLabelLoadingIndicator('point_type');

    // see CoreBundle/AjaxController
    var query = "action=plugin:KompulseNeed:getActionForm&actionType=" + actionType;
    mQuery.ajax({
        url: mauticAjaxUrl,
        type: "POST",
        data: query,
