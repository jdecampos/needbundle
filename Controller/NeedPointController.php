...
/**
 * Class NeedPointController.
 */
class NeedPointController extends FormController
{
    /**
     * @param int $page
     *
    ...
    {
        $model = $this->getModel('kompulse_point.need_point');
        ...
        $action  = $this->generateUrl('kompulse_point_action', ['objectAction' => 'new']);
        ...
        return $this->delegateView([
            'viewParameters' => [
                'tmpl'    => $this->request->isXmlHttpRequest() ? $this->request->get('tmpl', 'index') : 'index',
                'entity'  => $entity,
                'form'    => $this->setFormTheme($form, 'KompulseNeedBundle:Point:form.html.php', $themes),
                'actions' => $actions['actions'],
            ],
            ...
            'passthroughVars' => [
                'activeLink'    => '#mautic_point_index',
                'mauticContent' => 'point',
                'route'         => $this->generateUrl('kompulse_point_action', [
